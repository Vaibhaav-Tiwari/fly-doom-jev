...
export default function BrainView({recording, step}: {recording: Recording; step: ReplayStep | null}) {
  ...
  useEffect(() => {
    ...
    const haloMaterial = new THREE.PointsMaterial({color: 0xe18a22, map: glowMap, size: .54, vertexColors: true, transparent: true, opacity: .5, blending: THREE.AdditiveBlending, depthWrite: false, depthTest: false, toneMapped: false, fog: false});
    const coreMaterial = new THREE.PointsMaterial({color: 0xf0bc64, map: glowMap, size: .19, vertexColors: true, transparent: true, opacity: .9, blending: THREE.AdditiveBlending, depthWrite: false, depthTest: false, toneMapped: false, fog: false});
    ...
    const actionMaterial = new THREE.PointsMaterial({color: 0xe85b6d, map: glowMap, size: .5, transparent: true, opacity: .78, blending: THREE.AdditiveBlending, depthWrite: false, depthTest: false, toneMapped: false, fog: false});
    ...
    const retinaMat = new THREE.PointsMaterial({color: 0xe0ad4f, map: glowMap, size: .4, vertexColors: true, transparent: true, opacity: .68, blending: THREE.AdditiveBlending, depthWrite: false, depthTest: false, toneMapped: false, fog: false});
