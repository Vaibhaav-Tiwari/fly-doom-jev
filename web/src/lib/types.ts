...
export interface RecordingHeader {kind:string;recording_format_version?:string;created_at?:number|string;seed?:number;controller?:ControllerMode;software_version?:string;environment_backend?:string;warnings?:string[];config?:Record<string,unknown>;connectome?:{provenance?:any;populations?:Record<string,unknown>;n_neurons?:number;n_edges?:number;neurons?:NeuronSample[]};jev?:Record<string,unknown>;bridge?:any;motor?:any;motor_population?:{indices?:number[];body_ids?:Array<number|string>};connectome_assets?:any;annotations?:any}
